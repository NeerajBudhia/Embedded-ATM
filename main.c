...
struct user users[] =
{ //9920476343 is the onboard number
	{"Neeraj",20000.00,"1234","+919920476343"},
	{"Hasnain", 199999.00, "5678","+919885284547"},
	{"Kushagra",69.00,"5721","+919114457418"},
	{"NeerajJIO",1000.00,"1111","+916361087103"}
};
/*
	*****************************************************************
	* LCD Driver 																							      *
...
{
	int i = 0;
	char test[32] = "AT+CMGS=\"+919920476343\"\r\n";
	char end[] = "\x1a";
...
int verify_fn()
{
		...
		int i = 0;
		lcd_print("-----LOGIN------",1);
		lcd_print("send SMS secret pin",2);
